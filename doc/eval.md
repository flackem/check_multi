...
Continuation lines are supported with a trailing '\' at the end of the line ([Example here](eval#example_3san_data_replication_monitoring_horcm)). This allows human beings to read and understand command files :-D
